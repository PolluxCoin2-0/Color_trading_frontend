...
function App() {
  return (
    <div
      ...
      aria-modal="true"
    >
      <div className="bg-neutral-900/90 backdrop-blur-lg rounded-xl shadow-2xl p-8 max-w-lg mx-auto ">
        {/* Logo Section */}
        ...
        <div className="mt-6 flex justify-center">
          <div className="w-16 h-1 bg-gradient-to-r from-yellow-500 via-lime-500 to-red-400 rounded-full"></div>
        </div>
