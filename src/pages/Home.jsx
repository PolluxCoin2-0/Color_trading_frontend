...
const Home = () => {
  return (
    <div>
      ...
      {/* Main content */}
      <div className="bg-black w-full min-h-screen px-4 md:px-4 lg:px-24 flex flex-col items-center justify-center pr-4 lg:pr-20 xl:pr-20 2xl:pr-40 pb-10">
        ...
        <div
          className="flex flex-col items-center justify-start md:flex-row md:justify-center  md:items-center space-y-5 md:space-y-0 space-x-0 
        md:space-x-5 lg:space-x-10 w-full mt-10 ml-0 md:ml-0 lg:ml-0 xl:ml-0 2xl:ml-24"
        >
        ...
        <div className="mt-16 flex justify-center items-center">
          <div className="flex flex-row items-center space-x-4">
            <div className="flex flex-row">
              <img src={iconImg} alt="icon-image" className="" />
            </div>
